...
varianco v posamezni skupini in velikost posamezne skupine. Varianca, ki sva si jo izbrala, zavzame vrednosti:
...
Glede na moč testa lahko primerjamo vse tri teste le v primeru enakih varianc. V preostalih primerih klasični ANOVA test ni veljaven, zato bomo primerjali le preostala dva.

_Najprej primerjajmo med seboj teste v primeru enakih varinac._
...
```{r risanje moci enake var, fig.cap="Prikaz moči testa v primeru enakih varianc."}
# dava v format long
...
_Nato pa še primer, ko so variance različne._ \
...
```{r risanje moci razlicne var, fig.cap="Prikaz moči testa v primeru različnih varianc."}
# dava v format long
resLong_P = pivot_longer(res_p, cols=matches("^p[AM]"), values_to = "power",
                       names_to = "method", names_prefix = "p")
