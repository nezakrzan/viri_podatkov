...
Based on the above analysis, we would recommend using either Decision Trees or Multiple Imputation via Chained Equations (MICE) for handling missing values, as both methods appear suitable for our data. Although both methods had almost the same results, theory says different. With Decision Trees we underestimate variability and overestimate connectivity, so that is why Multiple Imputation via Chained Equations (MICE) is the most suitable method. 
