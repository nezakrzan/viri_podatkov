...
# spremebna ... v NA
# druzga nisem nc spremenila, se vedno so tvoji podatki povsod
# mogoce odstranva vrstice z NA vrednostmi za naprej?
# pa potem ne rabva v funkcijah da isce vrstice z NA vrednostmi?
#podatki2 = read.csv("podatki.csv", sep=';', na.strings = "...")
...
# krajse?
#tabela_mankajoce_vrednosti = podatki2[!complete.cases(podatki2), ]
#tabela_brez_na = na.omit(podatki2)
```
