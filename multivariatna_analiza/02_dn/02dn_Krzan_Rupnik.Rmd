...
Za domačo nalogo sva si izbrala spremenljivke, ki so bile kodirane z "EXT1-10" in "EST1-10". Te oznake predstavljajo trditev oz. osebnostno lastnost, katero so ankentiranci ovrednostili po zgornji lestvici. Pomen, pri čemer je s + oz. - označeno ali je trditev bila označena kot pozitivna (velja za ta sklop/lastnost), ali negativno (ne velja za ta sklop/lastnost, lestvica je obrnjena):
...
Ker želimo pojasniti čim več variabilnosti spremenljivk in korelacijo med spremenljivkami, se bomo to lotili z metodo glavnih komponent in faktorsko analizo. Metodi sta smiselni v primeru, ko so spremenljivke v podtkovnem okviru med seboj korelirane, zato si poglejmo korelacijsko matriko.
...
Zanima nas še, ali bomo imeli kakšne težave pri faktorski analizi, zato zivedemo še Kaiser-Meyer-Olkin test.
...
Podobno kot pri metodi glavnih komponent, si tudi tukaj lahko pomagamo s screenplotom, kjer gledamo kolena in koliko komponent je večjih od 1. Na podlagi zgornjega grafa je zelo očitno, da bi lahko imeli dva faktorja, tretji pa je na meji z ena. 
...
Na podlagi VSS predlaga 3 faktorje, pri čemer upoštevamouteži 1 in 2, saj po treh faktorjih oz. že po dveh zelo počasi narašča. eBIC minimum doseže pri 7 faktorjih, vendar je najboljše število faktorjev dva, saj prileganje pri večjem številu fakotrjev postaja zanemarljivo boljše. 
...
Pri pravokotni rotaciji si želimo, da bi bil indeks Tucker Lewis večji od 0.95 ali RMSE manjša od 0.05, da je fakotrska analiza zares dobra.Naš indeks je 0.82, RMSE pa 0.091, kar kaže na to, da fakotski model ni najboljši.

S prvim faktorjem pojasnemo 23% z drugim pa 43% variabilnosti med spremenljivkami, izmed vse pojasnene variabilnosti z izbranima dvema faktorjema s prvim faktorjem pojasnimo 54% variabilnosti, z drugim pa 46%.
