...
<!--Tom16: Tuki je tudi nekaj popravkov-->
S paralelno analizo dobimo podoben rezultat kot v prejšnjih primerih. Predlagano število glavnih komponent je 3 vendar je ta vrednost na meji (je tudi težko razvidno iz grafa), zato bomo obržali število glavnih komponent 2. V takšnih "robnih" primerih je smiselno izločiti zadnjo vrednost (torej v našem primeru 3 komponente). 
...
<!--Tom16: Ok neki sm popravu ampak nevem ce je to kar je zelel
Pa drugi del sploh nevem ce je kej prav-->
Interpretacija reskaliranih uteži je, da so spremenljivke čustvene stabilnosti (EST) negativno koreliren z drugo glavno komponento, medtem ko so spremenljivke energije pozitivno (EXT) korelirane. Prva komponenta je bolj ali manj močno pozitivno korelirana tako s spremenljivkami čustvene stabilnosti (EST) kot tudi s spremenljivkami energije (EXT).  

Če strnemo, prva glavna komponenta povzema tako pomembnost energije kot tudi čustvene stabilnosti, druga glavna komponenta pa povzema predvsem pomembnost čustvene stabilnosti (negativne korelacije).
