...
```{r}
modindices(object=cfa.fit, sort=T, maximum.number=10) # sort=T zato da jih izpiše od najboljše do najslabše
...
cfa.model1 <- "
  ...
  f2 =~ EST1 + EST2 + EST3 + EST4 + EST5 + EST6 + EST7 + EST8 + EST9 + EST1
	...
	EST1 ~~	EST2
	EST1 ~~	EST3
	EXT8 ~~	EXT9 # od tuki naprej se ni izbolšval
	# EST1 ~~	EST8
	# EST1 ~~	EST7
"
...
# indeksi prileganja
fitMeasures(cfa.fit, fit.measures = c("rmsea", "srmr", "cfi", "tli"))
summary(cfa.fit, fit=T, rsquare=T, standardized=T)
```

User Model še vedno ni statistično neznačilen($p = 0.000$), Baseline Model pa ostaja statistično značilen. RMSEA je tokrat 0.056, kar je pod 0.06, in je na podlagi tega model (mejno) sprejemljiv. SRMR je sedaj 0.047. CFI in TLI pa še vedno nista nad 0.95, ampak sta nad 0.9, TLI ima vrednost 0.934, CFI pa 0.944. 

Na podlagi mere prileganja bi rekla, da model sedaj je sprejemljiv in se prilega podatkom. 

## Merska enakovrednost
