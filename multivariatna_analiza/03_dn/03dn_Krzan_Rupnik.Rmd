...
Poglejmo si še korelacije med latentnimi spremenljivkami. Nio vse korelacije so pri stopnji značilnosti 0.05 statistično značilne($p < 0.001$), so pa vse pozitivne, kar pomeni, da da se s povečanjem vrednosti ene spremenljivke, poveča tudi vrednost druge.

Tudi tokrat imata Alien67 in SES statistično pomemben vpliv na Alien67, prvi pozitivnega(0.567), drugi pa negativnega(-0.208). Tudi SES ima statistično pomemben negativni vpliv na Alien67(-0.563).
...
<!-- Neza: tuki ne gledas Estimate ampak Std.all v istem izpisu, tko smo naredl na vajah, nevem kaj dava notr? kje si pa ti prebrau da gledas estimate?-->
* Alien71~SES ... -0.227 
* Alien67~SES ... -0.575
* Alien71~Alien67 ... 0.607
...
Posrednji vpliv izračunamo kot "$(Alien67 \sim SES) * (Alien71 \sim Alien67)$", torej $-0.575\cdot0.607 = -0.349$. \
Torej skupni vpliv je enak "$(Alien71 \sim SES) + (Alien67~SES)\cdot(Alien71\sim Alien67)$",  $-0.227 + -0.575\cdot0.607 = -0.576$. 
