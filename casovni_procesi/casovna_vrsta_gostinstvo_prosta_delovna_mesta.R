...
plot.ts(ts_strezba, type = "o", pch = 16, cex=0.6, 
        xlab = "leto", ylab = "indeks prihodka", xaxt="n")
axis(1, at=c(2008, 2011, 2014, 2017, 2020, 2023), 
     labels=c("2008", "2011", "2014", "2017", "2020", "2023"))
# gladilnik
...
boxCox(model_str1)
# ne bom nic transformirala

################################# ACF in PACF #################################
# Avtokorelogram in parcialni avtokorelogram za 'Dejavnost strežbe jedi in pijač'.

acf2(ts_strezba, main = "")
# trend - vrednosti avtokorelacijskih koeficientov padajo
# morda prisotna sezonskot, ker izgleda z večanjem odlogov kot cosinusno nihanje?
# pacf izgleda okej - z izjemo enega koeficienta pri večjem odlogu
# torej verjetno samo AR model? 
