...
```{r results=F, fig.cap="Časovna vrsta in napovedi na podlagi modela od leta 2020 naprej.", fig.width=5, fig.height=3}
...
```{r results=F, fig.cap="Časovna vrsta in napovedi na podlagi modela od sredine leta 2023 naprej.", fig.width=5, fig.height=3}
...
sarima.for(indeks.prihodka, n.ahead = 12*5, p = 5, d = 1, q = 6, P=2, D=1, Q=2, S=12, plot.all = TRUE)
points(test, type = "o")
```
...
sarima.for(prosta.delovna.mesta, n.ahead = 4*4, p = 0, d = 1, q = 0, plot.all = TRUE)
...
```{r results=F, fig.cap="Časovna vrsta in napovedi na podlagi modela od leta 2021 naprej.", fig.width=5, fig.height=3}
...
```{r results=F, fig.cap="Časovna vrsta in napovedi na podlagi modela od leta 2023 naprej.", fig.width=5, fig.height=3}
...
Napovedi tudi tukaj niso pravilne in ne ravno najbolj informativne, najbolje zadane samo za en trenutek naprej, 95% intervali zaupanja pa so še vedno izjemno široki, ampak zajemajo realne vrednosti.
...
sarima.for(zasedena.delovna.mesta, n.ahead = 4*4, p = 0, d = 1, q = 0, plot.all = TRUE)
...
Napovedi tudi tukaj niso pravilne, najbolje zadane samo za en trenutek naprej, 95% intervali zaupanja pa so še vedno izjemno široki, ampak vsebujejo realne vrednosti.
