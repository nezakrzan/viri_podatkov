...
```{r fig.height=4, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Porazdelitev parametrov glede na vrsto.", results=T}
library(ggplot2)
df = data 
...
```{r fig.height=5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Porazdelitev parametrov glede na lokacijo.", results=T}
