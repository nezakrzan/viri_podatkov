...
Napovedi in standardne napake napovedi za modela sta precej pričakovana. Z modelom _fit1.lm_ (zlato zrno je fiksno) dokaj dobro opišemo vrednosti semivarianc zato so tudi napovedi dobre. Prav tako so standardne napake napovedi majhne v točki meritve in se večajo, ko se od njih oddaljujemo. \
V primeru, ko vrednost zlatega zrna ni fiksna je napoved precej slabša. Sicer je možno razločiti, območje z nizkimi vrednostmi (zgornji levi kot) in območje z visokimi vrednostmi (spodnji desni kot). Prav tako so vrednosti standardne napake napovedi nekoliko višje le na skranih robovih, kjer nimamo meritev. 
...
Kot sva zapisal že zgoraj z modelom _fit2g.ml_ (vrednost zlatega zrna ni fiksna) bolje opišemo vrednosti semivarianc, zato lahko pričakujemo tudi nekoliko boljše napovedi. Če primerjamo zgornje grafe lahko vidimo, da v primeru, ko je vrednost zlatega zrna fiksa dosti slabše napovemo vrednosti (tudi območje z višjimi vrednostmi (spodnji desni kot) ni izrazit).
