...
```{r results=F, fig.cap="Napovedi NDRE za mesec julij za dano območje - model semivarigrama fit1.ml."}
...
```{r results=F, fig.cap="Napovedi NDRE za mesec julij za dano območje - model semivarigrama fit1_g.ml."}
xy.napovedi = data.frame(x=data$vrsta, y=data$lokacija)
